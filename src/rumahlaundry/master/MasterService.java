...
public class MasterService extends javax.swing.JFrame {
    ...
    private void dataTable() {
        ...
        try {
            ...
            if (result != null) {
                while (result.next()) {
                    String kode = result.getString("service_id");
                    String nama = result.getString("service_name");
                    String kontak = result.getString("service_price");
                    String alamat = result.getString("service_description");
                    String[] data = {kode, nama, kontak, alamat};
                    tabmode.addRow(data);
                }
            } else {
                JOptionPane.showMessageDialog(null, "Data Layanan tidak ditemukan");
                doReset();
            }
    ...
    private void doReset() {
        textKodeLayanan.setText("");
        textNamaLayanan.setText("");
        textHargaLayanan.setText("");
    ...
    private void initComponents() {
        ...
        jLabelKodeLayanan = new javax.swing.JLabel();
        textKodeLayanan = new javax.swing.JTextField();
        jLabelNamaLayanan = new javax.swing.JLabel();
        textNamaLayanan = new javax.swing.JTextField();
        jLabelHargaLayanan = new javax.swing.JLabel();
        textHargaLayanan = new javax.swing.JTextField();
        ...
        textKodeLayanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textKodeLayananActionPerformed(evt);
            }
        });

        jLabelNamaLayanan.setFont(new java.awt.Font("Tw Cen MT", 0, 14)); // NOI18N
        jLabelNamaLayanan.setText("Nama Layanan");

        textNamaLayanan.setFont(new java.awt.Font("Tw Cen MT", 0, 14)); // NOI18N
        textNamaLayanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textNamaLayananActionPerformed(evt);
            }
        });

        jLabelHargaLayanan.setFont(new java.awt.Font("Tw Cen MT", 0, 14)); // NOI18N
        jLabelHargaLayanan.setText("Harga Layanan");

        textHargaLayanan.setFont(new java.awt.Font("Tw Cen MT", 0, 14)); // NOI18N
        textHargaLayanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textHargaLayananActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabelHargaLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(textHargaLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabelKodeLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(45, 45, 45)
                                .addComponent(textKodeLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabelNamaLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(45, 45, 45)
                                .addComponent(textNamaLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelKodeLayanan)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelNamaLayanan)
                    .addComponent(textNamaLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelHargaLayanan)
                    .addComponent(textHargaLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        tableLayanan.setFont(new java.awt.Font("Tw Cen MT", 0, 12)); // NOI18N
        ...
        jScrollPane3.setViewportView(tableLayanan);
    ...
    private void textKodeLayananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textKodeLayananActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textKodeLayananActionPerformed

    private void textNamaLayananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textNamaLayananActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textNamaLayananActionPerformed

    private void textHargaLayananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textHargaLayananActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textHargaLayananActionPerformed

    public boolean doValidate() {
        boolean valid = false;
        if (MyHelper.validateTextRequired(textNamaLayanan)
                && MyHelper.validateTextRequired(textHargaLayanan)
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        ...
        try {
            String sql = "UPDATE MASTER_SERVICE SET SERVICE_NAME = ?, SERVICE_PRICE = ?, SERVICE_DESCRIPTION = ?"
            + " where SERVICE_ID = ?";
            PreparedStatement stat = connection.prepareStatement(sql);
            ...
            stat.setString(4, textKodeLayanan.getText());
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        try {
            String sqlDelete = "DELETE FROM MASTER_SERVICE where SERVICE_ID = ?";
            PreparedStatement statDelete = connection.prepareStatement(sqlDelete);
            statDelete.setString(1, textKodeLayanan.getText());
    ...
    private void tableLayananMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableLayananMouseClicked
        ...
        textKodeLayanan.setText(tableLayanan.getValueAt(row, 0).toString());
        textNamaLayanan.setText(tableLayanan.getValueAt(row, 1).toString());
        textHargaLayanan.setText(tableLayanan.getValueAt(row, 2).toString());
        textAreaKeterangan.setText(tableLayanan.getValueAt(row, 3).toString());
    ...
    private javax.swing.JLabel jLabelHargaLayanan;
    private javax.swing.JLabel jLabelKeterangan;
    private javax.swing.JLabel jLabelKodeLayanan;
    private javax.swing.JLabel jLabelNamaLayanan;
    ...
    private javax.swing.JTextField textHargaLayanan;
    private javax.swing.JTextField textKataKunci;
    private javax.swing.JTextField textKodeLayanan;
    private javax.swing.JTextField textNamaLayanan;
